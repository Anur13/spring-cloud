...
kafka-topics --command-config playground.config --bootstrap-server cluster.playground.cdkt.io:9092 --topic first_topic --create --partitions 1
...
kafka-console-producer --producer.config playground.config --bootstrap-server cluster.playground.cdkt.io:9092 --topic new_topic
> hello world!
...
# produce with keys
kafka-console-producer --producer.config playground.config --bootstrap-server cluster.playground.cdkt.io:9092 --topic first_topic --property parse.key=true --property key.separator=:
...
kafka-topics --bootstrap-server localhost:29092 --topic first_topic --create --partitions 1
...
# producing to a non existing topic
kafka-console-producer --bootstrap-server localhost:29092 --topic new_topic
> hello world!

# our new topic only has 1 partition
kafka-topics --bootstrap-server localhost:29092 --list
kafka-topics --bootstrap-server localhost:29092 --topic new_topic --describe
...
kafka-console-producer --bootstrap-server localhost:29092 --topic new_topic_2
hello again!

# this time our topic has 3 partitions
kafka-topics --bootstrap-server localhost:29092 --list
kafka-topics --bootstrap-server localhost:29092 --topic new_topic_2 --describe
