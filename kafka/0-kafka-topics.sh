...
kafka-topics --command-config playground.config --bootstrap-server cluster.playground.cdkt.io:9092 --create --topic first_topic
...
kafka-topics --bootstrap-server localhost:29092 --topic third_topic --create --partitions 3 --replication-factor 2

# Create a topic (working)
kafka-topics --bootstrap-server localhost:29092 --topic third_topic --create --partitions 3 --replication-factor 1
